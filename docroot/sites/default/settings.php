 ...
 * @endcode
 */
$settings['hash_salt'] = '47GXhq15F_z5HbV2P3blw6lBkfMXjKU0P_7Oct_5rImwGWD0g1wb1HRkh8wD3GY-rAJduzk7QA';
...
if (file_exists('/var/www/site-php')) {
  require '/var/www/site-php/nmnews/nmnews-settings.inc';
}
...
if (isset($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR']) && file_exists($_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_nmnews_dev_default.inc')) {
  require $_SERVER['DEVDESKTOP_DRUPAL_SETTINGS_DIR'] . '/cld_devcloud_nmnews_dev_default.inc';
}
// </DDSETTINGS>
